...
const Homepage = () => {
    ...
    <div className="flex bg-gray-200" style={{ maxHeight: "100vh", overflowY: "auto" }}>
      ...
      <div className="min-h-screen p-7 w-full bg-white rounded-2xl mt-3 ml-3 mr-3">
        <div className="headingdash flex items-center justify-between">
          ...
          <div className="flex items-center mr-6 bg-gray-100 py-1 px-1 rounded-2xl shadow-md">
  <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-gray-300">
    ...
    />
        ...
        {/* -----Grids ----------*/}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-3 mt-6">
          {/* -----Reverse Countdown ----------*/}
