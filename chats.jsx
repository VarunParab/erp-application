    ...
    <div className="flex bg-gray-200">
      ...
      <div className="min-h-screen p-7 w-full bg-white rounded-2xl mt-3 ml-3 mr-3">
        <div className="flex">
          ...
          <div className="w-1/3 h-[635px] bg-gray-100 rounded-2xl p-4 overflow-y-auto">
  <h2 className="text-2xl ml-3 font-bold mb-4">All Chats</h2>
  <div className="space-y-4">
    {contacts.map((contact, index) => (
      <div
        key={index}
        className="relative flex items-center justify-between bg-white p-2 rounded-xl cursor-pointer"
      ...
      >
        ...
        <div className="flex-1">
          ...
          <div className="absolute top-1 right-2 text-sm text-gray-400">
            {contact.lastMessageTime}
          </div>

          {/* Truncated Last Message */}
          <div className="text-sm text-gray-400">
            {contact.messages[contact.messages.length - 1].text.length > 20
              ? `${contact.messages[
        ...
        {contact.unreadMessages > 0 && (
          ...
          <div className="w-2/3 h-[635px] bg-gray-200 p-4 rounded-2xl ml-4 flex flex-col">
              ...
              <>
                ...
                <div className="flex items-center mb-4 border-b pb-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">{contacts[selectedContact].status}</p>
                  </div>
                </div>
